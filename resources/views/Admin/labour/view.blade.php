...
@section('content')
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Labour Detail</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('labours.index') }}">Labour Detail</a></li>
                <li class="breadcrumb-item active" aria-current="page">Labour Detail</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row row-sm">
        <div class="col-lg-12 col-md-12">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-1">Labour Detail</h6>
                        <p class="text-muted card-sub-title"> Labour with details.</p>
                    </div>
                    <div class="container">
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-sm-8">{{ $record->designation }}</td>
                                            </tr>
                                            <tr>
                                                <th class="col-sm-4">With Dish</th>
                                                <td class="col-sm-8">{{ $record->with_dish ? 'Yes' : 'No' }}</td>
                                            </tr>
                                            <tr>
                                                <th class="col-sm-4">Guest</th>
                                                <td class="col-sm-8">{{ $record->guest }}</td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="d-flex">
                            <div class="justify-content-center">
                                <a href="{{ route('labours.index') }}" class="btn btn-primary ">
                                    Back to Labour
                                </a>
                            </div>
                        </div>
