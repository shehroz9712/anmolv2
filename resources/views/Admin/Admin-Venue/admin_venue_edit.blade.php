            ...
            <div class="card-body">
                ...
                <div class="row row-sm">
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <div class="">
                            <form method="POST" action="{{ route('admin-venues.update', $adminVenue->id) }}" onsubmit="return validateForm();">
                                @csrf
                                @method('PUT') <!-- Use the appropriate HTTP method for updating -->

                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input class="form-control" id="name" name="name" required type="text" value="{{ $adminVenue->name }}">
                                    <small id="nameError" class="text-danger"></small>
                                </div>
                                <div class="form-group">
                                    <label for="address">Address</label>
                                    <input class="form-control" id="address" name="address" required type="text" value="{{ $adminVenue->address }}">
                                    <small id="addressError" class="text-danger"></small>
                                </div>
                                <div class="form-group">
                                    <label for="city">City, State, ZipCode</label>
                                    <input class="form-control" id="city" name="city" required type="text" value="{{ $adminVenue->city }}">
