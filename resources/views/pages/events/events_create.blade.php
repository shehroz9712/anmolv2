              ...
              <div class="">
                <form method="POST" action="{{ route('events.store') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input data-toggle="tooltip" data-placement="bottom" placeholder="Birthday Bash" title="Event Name" class="form-control" id="name" name="name" required type="text">
                    <small id="nameError" class="text-danger"></small>
                  </div>

                  <div class="form-group">
                    <label for="guests">Number of Guests</label>
                    <input data-toggle="tooltip" data-placement="bottom" placeholder="50" title="Number Of Guests" class="form-control" id="guests" name="guests" type="number" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input data-toggle="tooltip" data-placement="bottom" placeholder="01/09/2024" title="Event Date" class="form-control datepicker" data-provide="datepicker" name="date" autocomplete="off" type="" id="datepickerr" required>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group " data-placement="bottom" data-align="top" data-autoclose="false" data-format="hh:mm">
                      <input data-toggle="tooltip" data-placement="bottom" placeholder="06:00 PM" title="Start Time" type="text" id="start_time" name="start_time" class="form-control  timePicker">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group " data-placement="bottom" data-align="top" data-autoclose="false" data-format="hh:mm">
                      <input data-toggle="tooltip" data-placement="bottom" placeholder="10:00 PM" title="End Time" type="text" id="end_time" name="end_time" required class="form-control timePicker">
                      <span class="input-group-addon custom-addon bg-primary">
                        <i class="fa fa-clock-o text-light" aria-hidden="true" style="line-height: 36px;"></i>
                      </span>
                    </div>
                  ...
                  <div class="form-group">
                    <label for="type">Event Type <button class="btn ripple btn-primary btn-sm" data-bs-container="body" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-placement="top" data-bs-popover-color="default" data-bs-toggle="popover" title="Popover top" type="button">
                  ...
                  <div class="form-group" style="display: none;" id="addressField">
                    ...
                    <input data-toggle="tooltip" data-placement="bottom" aria-autocomplete="false"   placeholder="Enter address" title="Address" class="form-control" autocomplete="false" id="address" name="address" type="text">
                  ...
                  <div class="form-group" style="display: none;" id="otherTypeField">
                    ...
                    <input data-toggle="tooltip" data-placement="bottom" placeholder="Business Conference" title="Other Event Type" class="form-control" id="otherType" name="otherType" type="text">
                  ...
                  <div class="d-flex">
                    <div class="d-flex justify-content-end w-100">
                      <div class="d-inline-block my-2">
                        <button onclick="validateAndSubmit(event, validateForm())" class="btn ripple btn-primary" id="submitBtn">Submit</button>
                      </div>
                    </div>
                  </div>
                </form>
...
<script>
  ...
  if (startTime == "" || endTime == ""){
    ...
    function validateForm() {
            ...
            if (type === 'Other' && (otherType.trim() === '' || /^\s+$/.test(otherType) || /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/.test(otherType))) {
                document.getElementById('otherTypeError').textContent = 'Other Event Type is required and cannot contain special characters';
                isValid = false;
            }
