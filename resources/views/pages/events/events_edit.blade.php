            ...
            <div class="card-body">
                ...
                <div class="row row-sm">
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <div class="">
                            <form method="POST" id="myForm" action="{{ route('events.update', ['eventId' => $eventId]) }}">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="name">Event Name</label>
                                    <input data-toggle="tooltip" data-placement="bottom" title="Event Name" class="form-control" id="name" name="name" required type="text" placeholder="E.g., Anniversary Celebration" value="{{ $event->name }}">
                                    <small id="nameError" class="text-danger"></small>
                                </div>
                            
                                <div class="form-group">
                                    <label for="guests">Number of Guests</label>
                                    <input data-toggle="tooltip" data-placement="bottom" title="Number Of Guests" class="form-control" id="guests" name="guests" type="number" required placeholder="E.g., 50" value="{{ $event->guests }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input data-toggle="tooltip" data-placement="bottom" title="Event Date" class="form-control datepicker" data-provide="datepicker" type="text" id="datepickerr" name="date" placeholder="Select event date" value="{{ $event->date }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="timePicker">
                                        <input data-toggle="tooltip" data-placement="bottom" title="Start Time" type="text" id="start_time" name="start_time" placeholder="E.g., 6:00 PM" class="form-control input-group-addon timePicker" value="{{ $event->start_time }}">
                                       
                                        <span class="input-group-addon custom-addon bg-primary">
                                            <i class="fa fa-clock-o text-light" aria-hidden="true" style="line-height: 36px;"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="endTimePicker">
                                        <input data-toggle="tooltip" data-placement="bottom" title="End Time" type="text" id="end_time" name="end_time" required placeholder="E.g., 10:00 PM" class="form-control input-group-addon timePicker" value="{{ $event->end_time }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" required id="type" name="type" onchange="handleEventTypeChange()">
                                        <option label="Select Event Type"></option>
                                        <option value="Pick up" @if($event->type === 'Pick up') selected @endif>Pick up</option>
                                        <option value="Drop-off" @if($event->type === 'Drop-off') selected @endif>Drop-off</option>
                                        <option value="Setup service" @if($event->type === 'Setup service') selected @endif>Setup service</option>
                                        <option value="Off-premise" @if($event->type === 'Off-premise') selected @endif>Off-premise</option>
                                        <option value="Full service" @if($event->type === 'Full service') selected @endif>Full service</option>
                                ...
                                <div class="form-group" style="display: none;" id="locationField">
                                    ...
                                    <select class="form-control" id="location" name="location">
                                        <option value="Milwaukee" @if($event->location === 'Milwaukee') selected @endif>Milwaukee</option>
                                        <option value="Naperville" @if($event->location === 'Naperville') selected @endif>Naperville</option>
                                    </select>
                                ...
                                <div class="form-group" style="display: none;" id="addressField">
                                    ...
                                    <input data-toggle="tooltip" data-placement="bottom" title="Event Address" class="form-control" id="address" name="address" type="text" placeholder="E.g., 123 Main St" value="{{ $event->address }}">
                                ...
                                <div class="form-group" style="display: none;" id="AddressDetails">
                                    ...
                                    <input data-toggle="tooltip" data-placement="bottom" disabled   class="form-control" id="City" type="text">
                                  
                                    <label for="State" id="StateLabel">State</label>
                                    <input data-toggle="tooltip" data-placement="bottom" disabled   class="form-control" id="State" type="text">
                                  
                                    <label for="ZipCode" id="ZipCodeLabel">Zip Code</label>
                                    <input data-toggle="tooltip" data-placement="bottom" disabled   class="form-control" id="ZipCode" type="text">
                                  
                                    <label for="Country" id="CountryLabel">Country</label>
                                    <input data-toggle="tooltip" data-placement="bottom" disabled   class="form-control" id="Country" type="text">
                                  
                                  </div>
                                 
                                <div class="form-group" style="display: none;" id="otherTypeField">
                                    <label for="otherType">Other Event Type</label>
                                    <input data-toggle="tooltip" data-placement="bottom" title="Other Event Type" class="form-control" id="otherType" name="otherType" type="text" placeholder="E.g., Corporate Meeting" value="{{ $event->type_id === null ? $event->type : '' }}">
                            ...
                            <div class="d-flex">
                                <div class="d-flex justify-content-end w-100">
                                    <div class="d-inline-block my-2">
                                        <button class="btn ripple btn-main-primary d-inline-block" onclick="validateForm()" id="submitBtn">Update</button>
                                    </div>
                                </div>
                            </div>
...
@section('js')
<script async src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAP_API_KEY') }}&loading=async&libraries=places&callback=initMap"></script>
